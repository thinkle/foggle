...
<style>
	...
	.present {
		...
		animation:
			pop-in 300ms,
			fade-to-present 300ms ease-out;
		animation-fill-mode: both;
	}
	...
	.incorrect {
		...
		animation:
			pop-in 300ms,
			fade-to-incorrect 300ms ease-out;
		animation-fill-mode: both;
	}
	...
	.correct-left {
		...
		animation:
			pop-in 300ms,
			fade-to-correct-left 300ms ease-out;
		animation-fill-mode: both;
	}
	...
	.correct-right {
		...
		animation:
			pop-in 300ms,
			fade-to-correct-right 300ms ease-out;
		animation-fill-mode: both;
	}
	...
	.correct-left-and-right {
		...
		animation:
			pop-in 300ms,
			fade-to-correct-both 300ms ease-out;
		animation-fill-mode: both;
	}
